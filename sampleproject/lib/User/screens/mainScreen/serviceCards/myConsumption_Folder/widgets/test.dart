...
class MychartsTest extends StatefulWidget {
  MychartsTest({Key? key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<MychartsTest> {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: <Widget>[
        ...
        myCustomButton(text: "back", toClass: loginPageClass),
      ],
    );
  }
  ...
  Future<String> getChatDataFromJson() async {
    return rootBundle.loadString(myMenAvatar);
  }
