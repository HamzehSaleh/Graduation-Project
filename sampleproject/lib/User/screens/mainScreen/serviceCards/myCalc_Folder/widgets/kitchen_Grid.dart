...
final List<String> kithcen_names = [
  "ثلاجة",
  "جلاية أطباق",
  "خلاط",
  "مايكرويف",
...
final List<String> kitchen_imgs = [
  fridge,
  glassWacher,
  khallat,
  microwave,
...
List<Widget> _listTile = <Widget>[
  BackGroundTile(
    text: kithcen_names[++public_index],
    index: public_index,
    img: kitchen_imgs[public_index],
  ),
  BackGroundTile(
    text: kithcen_names[++public_index],
    index: public_index,
...
class myKitchenGrid extends StatefulWidget {
  @override
  State<myKitchenGrid> createState() => _myKitchenGridState();
}

class _myKitchenGridState extends State<myKitchenGrid> {
          ...
          child: Align(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                //    (result + other_result + living_result).toString() +
                //    " واط ");
                // result_List.clear();

                // print("this is list" + result_List.toString());

                // resultDialog(context, result + other_result + living_result);
              },
              child: Text(
                "حساب الاستهلاك وحفظ",
