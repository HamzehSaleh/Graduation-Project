...
final List<double> consumption = [175, 110, 1950, 3000, 1350, 2000, 3000];

final List<String> other_names = [
  "حاسوب مكتبي",
  "مروحة",
  "مجفف شعر",
  "سخان ماء",
...
List<Widget> _listTile = <Widget>[
  BackGroundTile(
    text: other_names[++public_index],
    index: public_index,
    img: other_imgs[public_index],
  ),
  BackGroundTile(
    text: other_names[++public_index],
    index: public_index,
...
class myOtherGrid extends StatefulWidget {
  @override
  State<myOtherGrid> createState() => _myOtherGridState();
}

class _myOtherGridState extends State<myOtherGrid> {
          ...
          child: Align(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                //resultDialog(context, result + kitchen_result + living_result);
              },
              child: Text(
                "حساب الاستهلاك وحفظ",
